...
<title><spring:message code="SH_title" /></title>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<span class="navbar-brand"><spring:message code="SH_title" /></span>
			</div>
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="studenthome.htm"><spring:message code="SH_title" /></a></li>
	...
	<div class="container body_width_eq">
		<div class="center-template">
			<h1 class="page-header">
				<spring:message code="SH_subtitle" />
				${model.studentName}
			</h1>
			<p class="lead">
