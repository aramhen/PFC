...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#answers tbody ').on('click', 'button.equations', function (event) {
		...
		$('#answers tbody ').on('click', 'button.steps', function (event) {
			var table = $("#answers").DataTable();
		    var row;
			if($(this).closest('tr').hasClass('child')){
				row = $(this).closest('tr').prev().get(0);
		...
		<div class="container">
			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="studentlistanswer.htm"><spring:message code="SLA_title" /></a></li>
				</ul>
			</div>
			<!--/.nav-collapse -->
		</div>
	...
	<div class="container">
		<div class="init-template">
			...
			<form:form action="" method="GET">
				<h2 class="center">
					<spring:message code="SLA_subtitle" /><br> <br>
				</h2>
				<table id="answers" class="table table-striped table-bordered hover" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th><spring:message code="SLA_table_problem" /></th>
							<th><spring:message code="SLA_table_teacher" /></th>
							<th><spring:message code="SLA_table_answerDate" /></th>
							<th><spring:message code="SLA_table_equations" /></th>
							<th><spring:message code="SLA_table_solution" /></th>
							<th><spring:message code="SLA_table_steps" /></th>
						</tr>
					</thead>
				</table>
			</form:form>
