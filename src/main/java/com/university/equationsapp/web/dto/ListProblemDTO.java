...
public class ListProblemDTO implements Serializable {

	/**
	 * ARH TODO habrá que ver las posibles transformaciones de equations, como meterle </br> entre cada ecuación. Si no hay solution no mostrar el botón de ver más.
	 */
